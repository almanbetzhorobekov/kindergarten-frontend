...
export default function Header() {
  const [anchorOrg, setAnchorOrg] = useState<HTMLButtonElement | null>(null);
  const [anchorPerson, setAnchorPerson] = useState<HTMLButtonElement | null>(
    null,
  );
  const [anchorInfo, setAnchorInfo] = useState<HTMLButtonElement | null>(null);
